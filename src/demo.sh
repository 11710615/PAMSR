...
# python main.py --model rcan --scale 2 --patch_size 48 --n_resblocks 20 --n_feats 64 --save rcan_48_20_1_64_x2 --reset --n_GPUs 3
#python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_96_16_x2 --reset --data_train DIV2K+DIV2K-Q75 --data_test DIV2K+DIV2K-Q75

# test
# python main.py --data_range 101-131 --scale 2 --pre_train ../experiment/edsr_48_32_0.1_256_x2/model/model_latest.pt --test_only --save_results --n_resblocks 32 --res_scale 0.1 --cpu --model EDSR --patch_size 48 --n_feats 256

python main.py --scale 2 --save edsr_16_32_0.1_256_x2 --n_resblocks 32 --res_scale 0.1 --model EDSR --patch_size 16 --n_feats 256 --n_GPUs 4
python main.py --model rcan --scale 2 --patch_size 16 --n_resblocks 20 --n_feats 64 --save rcan_16_20_1_64_x2 --reset --n_GPUs 4
python main.py --model SAN --save SAN_96_10_1_64_x2 --scale 2 --n_resgroups 20 --n_resblocks 10 --n_feats 64  --reset --chop --save_results --patch_size 96 --gpu_ids 1
