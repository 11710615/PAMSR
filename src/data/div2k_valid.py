...
class DIV2K_valid(srdata.SRData):
    def __init__(self, args, name='DIV2K_valid', train=True, benchmark=False):
    ...
    def _scan(self):
        names_hr, names_lr = super(DIV2K_valid, self)._scan()
    ...
    def _set_filesystem(self, dir_data):
        super(DIV2K_valid, self)._set_filesystem(dir_data)
