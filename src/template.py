def set_template(args):
    ...
    #     args.rgb_range = 1
        ...
        args.chop = True
        args.scale = '2'
        args.data_train = 'real_data'#'real_data'
        args.data_test = 'real_data' #'real_data'
        args.rgb_range = 1
        if args.patch_select=='random':
            flag = ''
        else:
        ...
        args.save = 'real_x{}/'.format(args.scale) + args.template+'_'+args.model + '_' + args.data_train
        args.pre_train = '/mnt/pank/SPSR/experiment/grad_window_proposed_x2_1*RL1+0.5*rec_norec_reg_mid/0/model/model_best.pt'
        # args.pre_train = '../experiment10/'+ '{}_x2_{}_mid_filter'.format(args.model.lower(),args.model) + '/0/model/model_best.pt'
...
#########################################################################################
    ...
    if args.template == 'proposed_x2':
        ...
        args.tile = True
        args.scale = '2'
        args.data_train = 'test_unreg_mid'#'test_mid_reg'
        args.data_test = 'test_unreg_mid'#'test_unreg_mid'
        args.rgb_range = 1
        if args.patch_select=='random':
            flag = ''
        else:
        ...
        args.save = 'syn_x{}/'.format(args.scale) + flag+'proposed_x2_' + args.loss + '_' + flag_rec + '_' + args.data_train
    ...
    if args.template == 'proposed_x4':
        ...
        args.tile = True
        args.scale = '4'
        args.data_train = 'test_mid_reg'#'reg_mid'
        args.data_test = 'test_mid_reg'#'reg_mid'
        args.rgb_range = 1
        if args.patch_select=='random':
            flag = ''
        else:
        ...
        if args.rec:
            ...
            flag_rec = 'norec'
        args.save = 'syn_x{}/'.format(args.scale) + flag+'proposed_x4_' + args.loss + '_' + flag_rec + '_' + args.data_train
        args.pre_train = '/mnt/pank/SPSR/experiment9/grad_window_proposed_x4_1*RL1+0.5*rec_norec_burst_v3/0/model/model_best.pt'
    ...
    if args.template == 'proposed_x8':
        ...
        if args.add_spmap:
            ...
            flag_spmap = ''
        args.save = 'syn_x{}/'.format(args.scale) + flag+'proposed_x8_' + args.loss + '_' + flag_rec + '_' + args.data_train
...
######################################## latest_compared methods ##############################
# efficent sr#
    if args.template == 'dat_x2':
        args.model = 'dat'
        args.patch_size = (64, 64)
        args.num_features = 180
        args.burst_size = 1
